...
export BUILDPKG="github.com/HyperNetworks/Knitter"
...
export GOPATH="$(echo "$FILEDIR" | awk -F "/src/github.com/HyperNetworks/" '{print $1}')"
echo "filedir=${FILEDIR}  gopath=${GOPATH}"

export KNITTERPATH="$GOPATH/src/github.com/HyperNetworks/Knitter"
