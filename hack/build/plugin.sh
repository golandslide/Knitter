...
if [ ${OPERATION} = "build" ];then
	...
	${GO}/go clean
	${GO}/go build -o knitter-plugin -v -x -ldflags "-X github.com/HyperNetworks/Knitter/pkg/version.moduleName=${MODULENAME} -X github.com/HyperNetworks/Knitter/pkg/version.verType=${VERTYPE} -X github.com/HyperNetworks/Knitter/pkg/version.versionInfo=${BRANCH_VERSION} -X github.com/HyperNetworks/Knitter/pkg/version.gitHash=${GITHASH} -X github.com/HyperNetworks/Knitter/pkg/version.buildTime=${BUILDTIME}"
